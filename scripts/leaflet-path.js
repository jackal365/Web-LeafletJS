        ...
        _updateMultiPoly: function(layer) {
            ...
            var drawAnimFramePoly = function() {
                ...
                if (!layer._curGroupCount && !groupNum) {
                    ...
                    // 箭头用固定的颜色画
                    this._curColor = "#00FF00"; //layer._groupArray[groupNum].color;
    ...
    var MultiPolyline = L.Layer.extend({
        ...
        _setColor: function(speed) {
            ...
            if (speed <= 2) {
                ...
                color = '#005500'; // OrangeRed
            } else if (speed <= 6) {
                color = '#008800'; // Firebrick1
            } else if (speed <= 8) {
                color = '#00AA00'; // Orange1
            } else if (speed <= 10) {
                color = '#00DD00'; // Gold1
            } else if (speed <= 12) {
                color = '#CCDD00'; // Yellow1
            } else if (speed <= 16) {
                color = '#FF8830'; // OliveDrab1
            } else if (speed <= 100) {
                color = '#FF3300'; // Chartreuse1
            } else {
                color = '#222222'; // Green1
            }
